...
/**
 * @brief Converts image into 2D Array
 *
 */
int8_t** img2mtx(int color);

/**
 * @brief deallocate memory for 2D Array 
 *
 */
...
//int16_t** get_neighbors(int w, int h, int16_t** m);

int16_t** f2sum(int8_t** m);

int16_t** ffsum(int8_t** A, int8_t** B);

//int16_t** umatrix(int8_t** fx, int8_t** fy, int8_t** ft);
